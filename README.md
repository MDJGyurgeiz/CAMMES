...
**Versione corrente: v3.3.0** (firmware Arduino **3.6**) — la versione in esecuzione è mostrata in basso a destra in ogni pagina; il controllo aggiornamenti è automatico (GitHub Releases).
